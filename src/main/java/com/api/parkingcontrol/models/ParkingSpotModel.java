...
public class ParkingSpotModel implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.AUTO) //Id gerado automatico na base de dados
    private UUID id;
    @Column(nullable = false, unique = true, length = 10) //vai ter valor, unico, máximo de 10
    private String parkingSpotNumber; //Numero da vaga
    @Column(nullable = false, unique = true, length = 7)
    private String licensePlateCar; //Placa dor carro
    ...
    private String responsibleName; //Nome do r
    // esponsável
